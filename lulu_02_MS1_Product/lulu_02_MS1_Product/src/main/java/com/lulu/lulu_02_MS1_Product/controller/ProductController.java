...
import com.lulu.lulu_02_MS1_Product.CustomerCareRestController;
...
//	}
	...
	@GetMapping("/productToCustomer")

	public String helloProduct() {

		// Here we are trying to invoke or call other microservice methods or
		// implementations
